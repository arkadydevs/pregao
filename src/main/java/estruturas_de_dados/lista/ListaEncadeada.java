...
public class ListaEncadeada<T> {
    ...
    public ListaEncadeada<T> getElements() {
        ListaEncadeada<T> elementsList = new ListaEncadeada<>();
        Elemento<T> current = primeiro;

        while (current != null) {
            elementsList.addElemento(current.getValor());
